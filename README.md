...
### 📐 قياسات هندسية متقدمة

- **الزوايا**: حساب الزاوية الداخلية (بالدرجات) عند منتصف آخر ثلاث نقاط، مع رسم قوس الزاوية على الصورة
- **طول المسار**: مجموع المسافات عبر كل النقاط المحفوظة، وليس آخر نقطتين فقط
- **المساحة**: مساحة المضلّع المكوّن من النقاط عبر صيغة Shoelace
- **الصندوق المحيط**: أبعاد أصغر مستطيل يحيط بجميع النقاط

### 🎯 المعايرة للوحدات الحقيقية

- **مقياس مخصص**: حدّد مسافة مرجعية معروفة (مثلاً 10 سم) لتحويل البكسل إلى وحدات حقيقية
- **وحدات متعددة**: مم، سم، م، إنش، قدم
- **تحويل شامل**: المسافة والمسار والمساحة تُعرض تلقائياً بالوحدة المختارة

### 🖼️ مقاييس الصورة

- **الأبعاد**: العرض والارتفاع بالبكسل
- **نسبة الأبعاد**: مبسّطة تلقائياً (مثل 16:9)
- **الميجابكسل**: إجمالي دقة الصورة
...
- **تصدير JSON**: حفظ النقاط مع كامل سياق القياس (مقاييس الصورة، المعايرة، المسار، المساحة، الصندوق المحيط)
